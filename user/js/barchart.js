...
go.addEventListener("click", changeActivityUnit);

let unitLabel = 'Kilometers Run';

/* 
  edits the unit label for the y-axis of chart base on the activty requested by the user
*/
function changeActivityUnit() {
  let activity = document.getElementById("viewActivityFor").value;

  switch (activity) {
    case 'Walk': 
      unitLabel = 'Kilometers Walked'
      break;
    case 'Run': 
      break;
    case 'Bike':
      unitLabel = 'Kilometers Biked';
      break;
    case 'Swim':
      unitLabel = 'Laps Swam'
      break;
    case 'Yoga': 
      unitLabel = 'Minutes of Yoga'
      break;
    case 'Soccer': 
      unitLabel = 'Minutes of Soccer'
      break;
    case 'Basketball':
      unitLabel = 'Minutes of Basketball'
      break;
  }
}
